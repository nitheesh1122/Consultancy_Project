...
import { Lock, User, ArrowRight, Factory, Truck } from 'lucide-react';
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (data.role !== 'SUPPLIER') {
                setError('This login is for suppliers only');
                return;
            }
            login(data);
        ...
        <div className="min-h-screen flex flex-col items-center justify-center bg-canvas relative overflow-hidden">
            ...
            <div className="z-10 w-full max-w-md px-4">
                <div className="text-center mb-8 flex flex-col items-center">
                    <div className="w-16 h-16 rounded-lg bg-emerald-600 flex items-center justify-center shadow-sm mb-6 shrink-0">
                        <Truck className="w-8 h-8 text-white" />
                    </div>
                    <h1 className="text-3xl font-bold font-heading text-primary tracking-tight">Supplier Portal</h1>
                    <p className="text-emerald-600 text-sm font-semibold tracking-wider mt-2 uppercase font-mono">Golden Textile Dyers</p>
                </div>
                ...
                <div className="bg-card p-8 rounded-lg border border-subtle shadow-md">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        <div className="space-y-2">
                            ...
                            <div className="relative group">
                                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                    <User className="h-5 w-5 text-muted group-focus-within:text-emerald-600 transition-colors" />
                                </div>
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative group">
                                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                    <Lock className="h-5 w-5 text-muted group-focus-within:text-emerald-600 transition-colors" />
                                </div>
