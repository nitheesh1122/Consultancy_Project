...
import RequestMaterialPage from './RequestMaterial';
import InventoryPage from './Inventory';
import MRSListPage from './MRSList';

import RaisePIPage from './RaisePI';
import PIApprovalsPage from './PIApprovals';
...
export const RequestMaterial = RequestMaterialPage;
export const MRSList = MRSListPage;
