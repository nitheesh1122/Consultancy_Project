...
router.post('/', protect, authorize('STORE_MANAGER', 'MANAGER'), requireManager, createWorker);
router.put('/:id', protect, authorize('STORE_MANAGER', 'MANAGER'), requireManager, updateWorker);
router.delete('/:id', protect, authorize('STORE_MANAGER', 'MANAGER'), requireManager, deleteWorker);
